...
describe('Tracking', function() {
  ...
  describe('API REST test', function()
    ...
    it('[POST]    Get tracking1 from all vehicles', function(done) {
    request(url)
    .post('/tracking1')
      .set('X-Access-Token','eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjIwOTA4MjY4NjU5MzMsImlzcyI6ImNydWVkYSIsInN1YiI6IlFjem1xaXFqc0JvMDIifQ.Vf1O_oIt-_pCqOP0yroA61ydJAMu2cZsMWdBHxu-GMk')
    // end handles the response
    ...
    it('[POST]    Get tracking from vehicle', function(done) {
      var body = {
        "initDate":"2017-02-07T06:02:06Z",
        "endDate": "2017-02-02T06:02:06Z"
      };
    request(url)
    .post('/tracking1/vehicle/4')
      .set('X-Access-Token','eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjIwOTA4MjY4NjU5MzMsImlzcyI6ImNydWVkYSIsInN1YiI6IlFjem1xaXFqc0JvMDIifQ.Vf1O_oIt-_pCqOP0yroA61ydJAMu2cZsMWdBHxu-GMk')
    .send(body)
    // end handles the response
    .end(function(err, res) {
